// Problem
// Seorang customer sedang makan di sebuah restaurant AYCE(All You Can Eat). Dia akan terus makan sampai waktu yang diberikan oleh restaurant tersebut habis.
...
function makanTerusRekursif(waktu) {
    ...
    if (waktu === 0) {
        ...
        count += 1;
        return sum + makanTerusRekursif(waktu-15);
    }
}//end function
